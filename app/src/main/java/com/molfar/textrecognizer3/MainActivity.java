package com.molfar.textrecognizer3;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setSubtitle("Натиснути малюнок тут");
    ...
    private void pickCamera() {
        ...
        values.put(MediaStore.Images.Media.DESCRIPTION, "Image to the text"); //description
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 203) {
            ...
            if (requestCode == 203) {
                ...
                //get drawable bitmap for text recognizer
